<template>
    <div class="content">
      ...
      <ul class="content-list">
        <li :class="{active:index==flag}" @click="selecte(item,index)" v-for="(item,index) in conList" :key="index">
          <span>{{item.text}}</span>
          <em>{{item.num}}</em>
        </li>
      </ul>
    ...
    export default {
      props:{
        ...
        methods: {
          ...
          selecte(item,index){
            if(item.text=="大"){
              this.showText="中奖和值:[6,7,8,9,10]";
            }
            if(item.text=="小"){
              this.showText="中奖和值:[1,2,3,4,5]";
            }
            if(item.text=="单"){
              this.showText="中奖和值:[1,3,5,7,9]";
            }
            if(item.text=="双"){
              this.showText="中奖和值:[2,4,6,8,10]";
            }
            if(item.text=="大单"){
              this.showText="中奖和值:[7,9]";
            }
            if(item.text=="大双"){
              this.showText="中奖和值:[6，8,10]";
            }
            if(item.text=="小单"){
              this.showText="中奖和值:[1,3,5]";
            }
            if(item.text=="小双"){
              this.showText="中奖和值:[2,4]";
            }
            this.flag=index;
            this.conList.map(item=>{
              if(this.conList[this.flag]==item){
